...
class DBProxyHandlerProxy : public HandlerProxyBasic,public CSingleton<DBProxyHandlerProxy>
{
	public:
	...
	public:
		int ProcessPacket(DBProxyHandlerToken * ptoken,const PBHead & head,const PBCSMsg & msg,const PBRoute & route);
	public:
