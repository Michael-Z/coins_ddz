...
{
	TGlobal::_svrd_type = EN_Node_Log;
    ...
    if (!CDBManager::Instance()->Init()) return false;
...
int main(int argc, char *argv[])
{
	...
	CTCPSocketServer<CTCPSocketHandler> _server(LogHandlerProxy::Instance(),TGlobal::_ip.c_str(),TGlobal::_port);
