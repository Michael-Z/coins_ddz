...
class GMHandlerProxy : public HandlerProxyBasic,public CSingleton<GMHandlerProxy>
{
	public:
	...
	public:
		int ProcessPacket(GMHandlerToken * ptoken,const PBHead & head,const PBCSMsg & msg,const PBRoute & route);
	public:
