...
class UserHandlerProxy : public HandlerProxyBasic,public CSingleton<UserHandlerProxy>
{
	public:
	...
	public:
		int ProcessPacket(UserHandlerToken * ptoken,const PBHead & head,const PBCSMsg & msg,const PBRoute & route);
	public:
